    ...
    <Preloader/>
      ...
      <div className="flex items-center h-screen w-full down-lg:mx-auto down-lg:justify-center xs:text-left down-lg:text-center ">
        ...
        <img
          ...
          src="assets/img/ratan-PhotoRoom.png-PhotoRoom (2).png"
          alt=""
        />
        {/* Desktop Image Ends */}
        <div className="from-lg:ml-100/3 from-lg:w-2/3">
          <div className="mx-auto max-w-550 custom-md-1:max-w-450">
            ...
            <h1 className="text-fs-51 text-accent font-Poppins relative uppercase font-bold leading-lh-62 pl-70 before:absolute before:left-0 before:top-29 before:h-4 before:w-40 before:rounded-10 custom-md-2:text-fs-42 down-xl:before:hidden down-xl:pl-0 custom-md-2:leading-lh-52 down-md:text-fs-38 down-md:leading-lh-48 down-md:mt-29 down-md:mb-13 xs:text-fs-29 xs:leading-lh-39 xs:mt-18">
              I'm RATAN KUMAR BAIDYA.
              <span className="block text-white">web designer & Developer</span>
            </h1>
            ...
            Greetings! I'm a skilled web designer and developer, merging creativity with technical finesse. Specializing in crafting visually appealing and functional websites, I bring digital visions to life through innovative design and robust development. Let's collaborate and create something extraordinary together.
            </p>
            <div
              id="link-about"
            ...
            >
              ...
              <span className="absolute -right-px bottom-0 w-55 h-55 flex items-center justify-center rounded-full text-white text-fs-19 fa fa-arrow-right bg-accent" />
            </div>
            {/* Informations Ends */}
          </div>
        </div>
